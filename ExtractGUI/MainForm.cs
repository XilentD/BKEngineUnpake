        ...
        private void cmdExtract_Click(object sender, EventArgs e)
        {
            ...
            switch (this.cmbType.SelectedIndex)
            {
                case 0:
                    ...
                    {
                        BKEUnpake.V20.BKARCFile bkarcV20 = new BKEUnpake.V20.BKARCFile(file);
                ...
                case 1:
                    foreach (string file in files)
                    {
                        BKEUnpake.V21.BKARCFile bkarcV21 = new BKEUnpake.V21.BKARCFile(file);
                ...
                case 2:
                    foreach (string file in files)
                    {
                        BKEUnpake.V40.BKARCFile bkarcV40 = new BKEUnpake.V40.BKARCFile(file);
